...
class ReservedKeywords implements Check
{
    ...
    {
        // Since reports are based on the column name, there is no point in creating a report for an element that
        // doesn't have this name as it will always be true.
        if (!in_array(strtolower($entity->getName()), self::RESERVED_KEYWORDS)) {
            return null;
        }
