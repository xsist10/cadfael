...
abstract class Fragment
{
    ...
    const COLLATION_TO_CHARACTER_SET = [
     ...
     */
    public static function getDefaultCollationForCharacterSet(string $character_set): string
    {
    ...
    /**
     * Convert a collation into it's base character set.
     *
     * @param string $collation
     * @return string
     * @throws UnknownCollation
     */
    public static function getCharacterSetFromCollation(string $collation): string
    {
        if (isset(self::COLLATION_TO_CHARACTER_SET[$collation])) {
            return self::COLLATION_TO_CHARACTER_SET[$collation];
        }
        throw new UnknownCollation("$collation is an unknown collation.");
    }

    /**
     * @param RootNode|null $node
     * @return string|null
     * @throws Exception
     */
    public static function resolveValue(?RootNode $node)
    {
        if (!$node) {
            return null;
        }
